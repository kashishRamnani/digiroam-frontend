...
const MinTopupRange = () => {
    ...
    return (
        <div className="bg-white table-container mb-8 shadow-md lg:h-[70%] rounded-lg p-6 mx-4 mt-10">
            <h2 className="text-xl font-bold text-gray-800 mb-4">ToupRange</h2>
            {!isEditing ? (
                <div className="flex justify-between items-center">
                    <p className="text-lg text-gray-700 mt-4">
                        Current Markup <strong>{minTopupRange}%</strong>
                    </p>
                    <button
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col space-y-4">
                    <label className="text-sm font-medium text-gray-700">Set Topup Range (%)</label>
                    <input
