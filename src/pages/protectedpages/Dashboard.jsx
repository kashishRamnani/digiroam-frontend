          ...
          <div className="relative w-[32rem] bg-white shadow-2xl h-full p-6 rounded-l-2xl transform transition-transform duration-300 ease-in-out animate-slide-in">
            ...
            <div className="mt-4 space-y-4 overflow-y-auto max-h-screen pr-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {/* <p><strong>Transaction ID:</strong> {selectedEsim.transactionId}</p> */}
                {/* <p><strong>ICCID:</strong> {selectedEsim.iccid}</p>
          <p><strong>IMSI:</strong> {selectedEsim.imsi || "N/A"}</p> */}
              ...
              {/* QR Code & Short URL in a Separate Line */}
              <div className="mt-4">
                <p className="mb-4"><strong>Expired Time:</strong> {new Date(selectedEsim.expiredTime).toLocaleString()}</p>
                <p className="mb-2">
